...
/**
 * Inverting calls to [org.cibseven.community.bpm.data.adapter.ReadAdapter].
 */
interface VariableReader {
    /**
     * Uses [org.cibseven.community.bpm.data.adapter.ReadAdapter.getOptional] to access variable value.
     *
    ...
    /**
     * Uses [org.cibseven.community.bpm.data.adapter.ReadAdapter.get]  to access variable value.
     *
     * @param variableFactory the variable to read
     * @param <T>             type of value
    ...
    /**
     * Uses [org.cibseven.community.bpm.data.adapter.ReadAdapter.getLocal] to access variable value.
     *
     * @param variableFactory the variable to read
     * @param <T>             type of value
     * @return value of variable
    ...
    /**
     * Uses [org.cibseven.community.bpm.data.adapter.ReadAdapter.getLocalOptional] ()}  to access variable value.
     *
     * @param variableFactory the variable to read
     * @param <T>             type of value
     * @return value of variable or empty()
    ...
    /**
     * Uses [org.cibseven.community.bpm.data.adapter.ReadAdapter.getOptional] to access variable value. If the optional is empty returns `null`
     *
     * @param variableFactory the variable to read
     * @param <T>             type of value
    ...
    /**
     * Uses [org.cibseven.community.bpm.data.adapter.ReadAdapter.getLocalOptional] to access variable value. If the optional is empty returns `null`
     *
     * @param variableFactory the variable to read
     * @param <T>             type of value
     * @return value of variable or `null` if the variable is not present or has value `null`.
