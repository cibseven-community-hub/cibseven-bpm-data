...
interface GlobalVariableWriter<S : GlobalVariableWriter<S>> {
     ...
     * @see [org.cibseven.community.bpm.data.adapter.WriteAdapter.set]
    </T> */
     ...
     * @param <T>             type of value
     * @return current writer instance
     * @see [org.cibseven.community.bpm.data.adapter.WriteAdapter.setLocal]
    </T> */
     ...
     * @param <T>             type of value
     * @return current writer instance
     * @see [org.cibseven.community.bpm.data.adapter.WriteAdapter.remove]
    </T> */
